...
"
    >
      ...
      >
        💬
        <span className="pointer-events-none absolute right-14 whitespace-nowrap rounded-lg bg-zinc-900 px-3 py-1 text-xs text-zinc-200 opacity-0 group-hover:opacity-100 transition">
