...
const testimonials = [
  { name: "Алексей Петров", text: "coobe помог мне забыть о просроченных платежах. Теперь всё под контролем.", rating: 5 },
  ...
  { name: "Ольга Морозова", text: "coobe стал моим надёжным финансовым помощником.", rating: 5 },
];
  ...
  return (
    <div className="flex-shrink-0 w-[340px] mx-4">
      <div className="testimonial-card flex flex-col h-[240px]">
        ...
        {/* Text - занимает доступное пространство, обрезается после 3 строк */}
