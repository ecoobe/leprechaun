...
export default function RegisterPage() {
  ...
  // Рассчитываем высоту контейнера для плавного расширения
  useLayoutEffect(() => {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen flex items-center justify-center px-6 py-24 text-zinc-100">
        {/* Motion container с плавной высотой */}
        <motion.div
          ref={containerRef}
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="
                      w-full rounded-xl bg-zinc-800/60 border border-zinc-700 px-4 py-3
                ...
                <Button
                  className="
                    w-full rounded-full py-3 bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500
                    text-white shadow-md hover:scale-105 hover:shadow-lg transition-all duration-300
                  "
                  onClick={() => setStep(2)}
                >
                  Получить код
