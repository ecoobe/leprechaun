          ...
          <div className="mx-auto max-w-7xl px-6 grid gap-20 lg:grid-cols-2 items-center">
            ...
            >
              ...
              <div className="mt-12 flex gap-6">
                <Link
                  href="#faq"
                  className="rounded-3xl bg-emerald-500 px-8 py-4 text-base sm:text-lg font-semibold text-zinc-950 hover:bg-emerald-400 transition"
                >
                  Узнать больше
                </Link>
                <Link
                  href="#faq"
                  className="rounded-3xl border border-zinc-700 px-8 py-4 text-base sm:text-lg font-semibold hover:bg-zinc-800 transition"
                >
                  Как начать?
                </Link>
              </div>
        ...
        <section className="relative z-10 mx-auto max-w-6xl px-6 py-32">
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur">
              <div className="text-emerald-400 text-xl sm:text-2xl font-semibold mb-3">📅 Умные напоминания</div>
              <p className="text-base sm:text-lg text-zinc-300 leading-relaxed">Telegram-бот пришлёт уведомление вовремя, чтобы вы не пропустили платеж</p>
            </div>
            <div className="rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur">
              <div className="text-emerald-400 text-xl sm:text-2xl font-semibold mb-3">🧾 Всё в одном месте</div>
              <p className="text-base sm:text-lg text-zinc-300 leading-relaxed">Кредитные карты, кредиты, ипотека — все обязательства на одной панели</p>
            </div>
            <div className="rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur">
              <div className="text-emerald-400 text-xl sm:text-2xl font-semibold mb-3">🤖 AI-помощник</div>
              <p className="text-base sm:text-lg text-zinc-300 leading-relaxed">«Плачу и плачу» поможет составить план погашения с учётом вашего дохода</p>
            </div>
          </div>
        </section>
